...
pygame.init()
sc = pygame.display.set_mode(RES, pygame.RESIZABLE | pygame.HWSURFACE)
...
game_bg = pygame.image.load('bg4.jpg').convert()

main_font = pygame.font.Font('font.ttf', 85)
font = pygame.font.Font('font.ttf', 45)

title_tetris = main_font.render('TETRIS', True, pygame.Color('red'))
title_score = font.render('score:', True, pygame.Color('orange'))
...
get_color = lambda : (randrange(0, 256), randrange(0, 256), randrange(0, 256))
